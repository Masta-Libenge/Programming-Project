            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="bg-white rounded-xl shadow-inner px-4 py-2 text-center text-gray-700">
                        ...
                        <input type="text" name="voornaam" placeholder="Voornaam" class="hidden edit-mode w-full text-center bg-transparent outline-none" value="{{ $user->voornaam }}">
                    </div>

                    <div class="bg-white rounded-xl shadow-inner px-4 py-2 text-center text-gray-700">
                        <label class="block text-sm text-[#1E40AF] mb-1">Achternaam</label>
                        <span class="view-mode">{{ $user->achternaam ?? 'Nog niet ingevuld' }}</span>
                        <input type="text" name="achternaam" placeholder="Achternaam" class="hidden edit-mode w-full text-center bg-transparent outline-none" value="{{ $user->achternaam }}">
                    </div>
                    ...
                    <div class="col-span-1 sm:col-span-2 bg-white rounded-xl shadow-inner px-4 py-2 text-center text-gray-700">
                        ...
                        <input type="email" name="email" placeholder="E-mailadres" class="hidden edit-mode w-full text-center bg-transparent outline-none" value="{{ $user->email }}">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="space-y-4">
                    <div class="bg-white rounded-xl shadow-inner px-4 py-2 text-center text-gray-700">
                        ...
                        <input type="text" name="opleiding" placeholder="Opleiding" class="hidden edit-mode w-full text-center bg-transparent outline-none" value="{{ $user->opleiding }}">
                    </div>

                    <div class="bg-white rounded-xl shadow-inner px-4 py-2 text-center text-gray-700">
                        <label class="block text-sm text-[#1E40AF] mb-1">Jaar</label>
                        <span class="view-mode">{{ $user->jaar ?? 'Nog niet ingevuld' }}</span>
                        <input type="text" name="jaar" placeholder="Jaar" class="hidden edit-mode w-full text-center bg-transparent outline-none" value="{{ $user->jaar }}">
                    </div>
                </div>
            </div>
